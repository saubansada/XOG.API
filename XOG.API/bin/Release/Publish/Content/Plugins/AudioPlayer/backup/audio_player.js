jQuery.fn.AudioPlayer = function (options) {
    ...
    var defaults = {
        rainbow: null,
        source: "",// "/content/plugins/AudioPlayer/media/cartoon.mp3",
    ...
    var controlTags = '<div class="audio_player" id="player_controls">' +
                         '<div id="play_pause" class="btn btn-lg play"><i class="fa fa-1x fa-play"></i></div>' +
