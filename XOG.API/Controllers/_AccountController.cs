...
{
    [RouteArea("")]
    public class AccountController : Abstracts.AuthController
    {  
        // GET: /Account/Login
        [AllowAnonymous]
                ...
                if (!signedUser.LockoutEnabled)
                {
                    ...
                    switch (result)
                    {
                        case SignInStatus.Success:
                            var roles = await UserManager.GetRolesAsync(signedUser.Id);
                        ...
                        default:
                            {
                                ModelState.AddModelError("", Language("InvalidLoginAttempt"));
                                return View(model);
                            }
                    }
                }
