...
namespace XOG
{
    public static class AppConfig
    {
        ...
        public static string TextLocalAPIKey
        {
            set
            {
                KeywordsHelper.SetKeywordValue("TextLocalApiKey", value);
            }

            get
            {
                return KeywordsHelper.GetKeywordValue("TextLocalApiKey");
            }
        }

        public static string QuesterSMSAPIKey
        {
            set
            {
                KeywordsHelper.SetKeywordValue("QuesterSmsApiKey", value);
            }

            get
            {
                return KeywordsHelper.GetKeywordValue("QuesterSmsApiKey");
            }
        }
        ...
        public static string IsProduction
        {
            set
            {
                KeywordsHelper.SetKeywordValue("IsProduction", value);
            }

            get
            {
                return KeywordsHelper.GetKeywordValue("IsProduction");
            }
        }
