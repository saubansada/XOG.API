...
BEGIN TRANSACTION
GO
PRINT N'Dropping Default Constraint unnamed constraint on [dbo].[ReturnOrderDetails]...';


GO
ALTER TABLE [dbo].[ReturnOrderDetails] DROP CONSTRAINT [DF__tmp_ms_xx__IsCan__2645B050];
...
GO
PRINT N'Creating Default Constraint unnamed constraint on [dbo].[ReturnOrderDetails]...';


GO
ALTER TABLE [dbo].[ReturnOrderDetails]
