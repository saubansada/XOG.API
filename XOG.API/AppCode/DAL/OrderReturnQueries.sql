...
BEGIN TRANSACTION
GO
PRINT N'Creating Table [dbo].[ReturnOrders]...';
...
CREATE TABLE [dbo].[ReturnOrders] (
    ...
    [ReturnOrderState] TINYINT    NOT NULL,
...
GO
PRINT N'Creating Foreign Key [dbo].[FK_ReturnOrders_Orders]...';


GO
ALTER TABLE [dbo].[ReturnOrders] WITH NOCHECK
    ADD CONSTRAINT [FK_ReturnOrders_Orders] FOREIGN KEY ([OrderId]) REFERENCES [dbo].[Orders] ([Id]) ON DELETE CASCADE;
...
GO
ALTER TABLE [dbo].[ReturnOrders] WITH CHECK CHECK CONSTRAINT [FK_ReturnOrders_Orders];
