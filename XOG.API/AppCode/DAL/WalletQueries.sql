...
BEGIN TRANSACTION
GO
PRINT N'Creating Table [dbo].[UserWallet]...';


GO
CREATE TABLE [dbo].[UserWallet] (
    [Id]             BIGINT            IDENTITY (1, 1) NOT NULL,
    [WalletOfUserId] NVARCHAR (128) NOT NULL,
...
GO
PRINT N'Creating Index [dbo].[UserWallet].[IX_FK_UserWallet_AspNetUsers]...';


GO
CREATE NONCLUSTERED INDEX [IX_FK_UserWallet_AspNetUsers]
    ON [dbo].[UserWallet]([WalletOfUserId] ASC);
