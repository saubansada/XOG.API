...
//        internal static object GetTList(XOGEntities context = null, CartFilterRequestVM filter = null, ListingType listType = ListingType.GridList, object model = null)
//        {
//            if (context == null)
//            {
//                using (var _context = new XOGEntities())
...
//                        throw new Exception(Constants.Messages.DB_CONTEXT_INIT_FAILED.ColonNextLine());
//                    }
//                    return GetTList(_context, filter, listType, model);
//                }
//            }
//            var query = GetFilteredQuery(filter, context);

//            return query.MapToCartModelListing(model, listType);
//        }

//        internal static object GetCartByNameOrId(XOGEntities context = null, long id = -1, string title = "", bool isAdmin = false)
//        {
//            if (context == null)
//            {
//                using (var _context = new XOGEntities())
...
//                        throw new Exception(Constants.Messages.DB_CONTEXT_INIT_FAILED.ColonNextLine());
//                    }
//                    return GetCartByNameOrId(_context, id, title, isAdmin);
//                }
//            }
//            var Cart = new Cart();
...
//            return query.FirstOrDefault().MapToCartModel();
//        }
