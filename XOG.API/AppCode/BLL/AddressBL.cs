...
namespace XOG.AppCode.BLL
{
    public class AddressBL
    {
        ...
        internal async Task<DBStatus> EditAsync(Address model, XOGEntities context = null)
        {
            ...
            {
                ErrorLogger.LogError(Constants.Messages.ERROR_UPDATING_ADDRESS.ColonNextLine() + ex.ToString());
        ...
        internal DBStatus Add(Address model, XOGEntities context = null)
        {
            ...
            {
                ErrorLogger.LogError(Constants.Messages.ERROR_ADDING_ADDRESS.ColonNextLine() + ex.ToString());
        ...
        internal async Task<DBStatus> DeleteAsync(long Id, XOGEntities context = null)
        {
            ...
            {
                ErrorLogger.LogError(Constants.Messages.ERROR_DELETING_ADDRESS.ColonNextLine() + ex.ToString());
